module Lorenz
    ...
    integer,parameter :: MaxT=2500000,T_trans=2400000,N=3,M=6
    real :: x(M,N),epsilon
...
program main
    ...
    open(10,file="x0.txt")
    open(20,file="x_1.txt")
    open(30,file="x_2.txt")
    open(31,file="x_3.txt")
    open(32,file="x_4.txt")
    open(33,file="x_5.txt")
    open(34,file="x_6.txt")
    ...
    do t=1,MaxT,1
        ...
        if(t>=T_trans) then
            ...
            write(31,*) (t-T_trans)*h,x(3,1),x(3,2),x(3,3)
            write(32,*) (t-T_trans)*h,x(4,1),x(4,2),x(4,3)
            write(33,*) (t-T_trans)*h,x(5,1),x(5,2),x(5,3)
            write(34,*) (t-T_trans)*h,x(6,1),x(6,2),x(6,3)
